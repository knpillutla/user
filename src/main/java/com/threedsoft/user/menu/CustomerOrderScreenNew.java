...
public class CustomerOrderScreenNew {
	public static ScreenResource createCustomerOrdersScreen(String busName, String facilityNbr) {
		...
		customerOrderDataResource.setListFields(
				"id,orderNbr,statCode,statCodeDesc,batchNbr,busName,facilityNbr,company,division,createdDttm,updatedDttm,createdBy,updatedBy");
...
//		}
	...
	private static DataResource getCustomerOrderDetailResource(String busName, String facilityNbr) {
		String searchUrl = "";
		String custOrderDtlListUrl = "https://the3dsoft.com/customerorder/api/customer-order-lines?busName.equals="
				+ busName + "&facilityNbr.equals=" + facilityNbr + "&customerOrderId.equals={customerOrderId}";
		String custOrderDtlAddRecordUrl = "https://the3dsoft.com/customerorder/api/customer-order-lines";
		String custOrderDtlupdateRecordUrl = "https://the3dsoft.com/customerorder/api/customer-order-lines";
		String custOrderDtldeleteRecordUrl = "https://the3dsoft.com/customerorder/api/customer-order-lines/{id}";
		...
		List<FieldResource> fieldList = new ArrayList();
		fieldList.add(FieldResource.createPrimaryField("id", "id", "int", "10"));
		fieldList.add(FieldResource.createField("customerOrderId", "Customer Order Id", "int", "10"));
		...
		fieldList.add(FieldResource.createDropDownField("statCode", "Stat Code", "int", "10",
				"100,200,300,400,500,600,700,800,900,1000", "None"));
		fieldList.add(FieldResource.createField("statCodeDesc", "Status Description", "string", "30"));
		fieldList.add(FieldResource.createField("createdDttm", "Created Dttm", "date", "20"));
		fieldList.add(FieldResource.createField("updatedDttm", "Updated Dttm", "date", "20"));
		fieldList.add(FieldResource.createField("createdBy", "Created By", "string", "25"));
		...
		addRecordFieldList.add(AddFieldResource.createHiddenFieldWithDefaultValue("busName", busName));
		addRecordFieldList.add(AddFieldResource.createHiddenFieldWithDefaultValue("facilityNbr", facilityNbr));
		addRecordFieldList.add(AddFieldResource.createHdrReferenceField("customerOrderId", "id"));
...
//		addRecordFieldList.add(AddFieldResource.createTextField("shippedQty"));
		...
		editRecordFieldList.add(ViewEditFieldResource.createDisabledField("customerOrderId"));
		editRecordFieldList.add(ViewEditFieldResource.createDisabledField("orderNbr"));
		...
		viewRecordFieldList.add(ViewEditFieldResource.createDisabledField("orderNbr"));
		viewRecordFieldList.add(ViewEditFieldResource.createDisabledField("customerOrderId"));
		...
		orderDtlResource.setListFields(
				"id,customerOrderId,orderNbr,lineNbr,statCode,statCodeDesc,itemBrcd,origQty, qty, allocatedQty, pickedQty, packedQty, shippedQty,createdDttm,updatedDttm,createdBy,updatedBy");
		// orderDtlResource.setAddRecordFields("origQty,qty,allocatedQty,pickedQty,packedQty,shippedQty");
		// orderDtlResource.setEditRecordFields("id,busName,facilityNbr,orderNbr,customerOrderId,lineNbr,orderQy");
		// orderDtlResource.setViewFields("id,customerOrderId,orderNbr,lineNbr,origQty,
