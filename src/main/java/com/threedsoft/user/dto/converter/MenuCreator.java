...
public class MenuCreator {
	...
	private MenuResource createFulfillmentMenu(String busName, Integer locnNbr) {
		...
		screenResourceList.add(createOrderPlannerScreen(busName, locnNbr));
	...
	private ScreenResource createSinglesRFPickScreen(String busName, Integer locnNbr) {
		ScreenResource rfScreen = new ScreenResource("SinglesRFPicking", "Singles RFPicking", "Singles RFPicking", "RW",
				UserConstants.RF_SCREEN, null, null);
		String searchUrl = "";
		String listUrl = "";
		...
		RecordResource hdrResource = new RecordResource("RFPicking", "Pick To Tote (Singles)", searchUrl, listUrl,
				getRecordUrl, addRecordUrl, updateRecordUrl, deleteRecordUrl, null, null, null, null, null, null,null);

		List<FieldResource> fieldList = new ArrayList();
		fieldList.add(new FieldResource("id", "id", "Y", "N", "int", "10", "", "update"));
		fieldList.add(new FieldResource("busName", "Bus Name", "Y", "N", "string", "25", "", "update","",busName));
		fieldList.add(new FieldResource("locnNbr", "Locn Nbr", "Y", "N", "int", "10", "", "update","",String.valueOf(locnNbr)));
	...
	private ScreenResource createRFPackScreen(String busName, Integer locnNbr) {
		ScreenResource rfScreen = new ScreenResource("RFPacking", "RFPackinge", "RFPacking", "RW",
				UserConstants.RF_SCREEN, null, null);
		String searchUrl = "";
		String listUrl = "";
		...
		String deleteRecordUrl = "";
		RecordResource hdrResource = new RecordResource("RFPacking", "Pack from Tote", searchUrl, listUrl, getRecordUrl,
				addRecordUrl, updateRecordUrl, deleteRecordUrl, null, null, null, null, null, null,null);
	...
	private ScreenResource createInventoryScreen(String busName, Integer locnNbr) {
		ScreenResource inventoryScreen = new ScreenResource("InventoryMaintenance", "Inventory Maintenance",
				"Item Inventory", "RW", UserConstants.MAINTENANCE_SCREEN, null, null);
		...
		String deleteRecordUrl = "https://the3dsoft.com/inventory/v1/" + busName + "/" + locnNbr + "/inventory"
				+ "/{id}";
		RecordResource inventoryHdrResource = new RecordResource("Inventory", "Inventory", searchUrl, invnListUrl,
				invnGetRecordUrl, invnAddRecordUrl, updateRecordUrl, deleteRecordUrl, null, null, null, null, null,
				null,null);
		...
		fieldList
				.add(new FieldResource("division", "Division", "N", "N", "string", "10", "", "list,detail,add,update"));
		fieldList.add(
				new FieldResource("locnBrcd", "Locn Brcd", "N", "N", "string", "20", "", "list,detail,add,update"));
		fieldList.add(
				new FieldResource("itemBrcd", "Item Brcd", "N", "N", "string", "20", "", "list,detail,add,update"));
		fieldList.add(new FieldResource("qty", "Qty", "N", "N", "int", "4", "", "list,detail,add,update"));
		fieldList.add(new FieldResource("locked", "Locked", "N", "N", "string", "1", "Y,N", "list,detail,add,update",
				"dropdown","N"));
		fieldList.add(new FieldResource("trackByIlpn", "Track By LPN?", "N", "N", "string", "1", "Y,N",
				"detail,add,update", "dropdown","N"));
	...
	private ScreenResource createPickingScreen(String busName, Integer locnNbr) {
		ScreenResource screen = new ScreenResource("PickingMaintenance", "Picking Maintenance", "Picking Maintenance",
				"R", UserConstants.MAINTENANCE_SCREEN, null, null);
		...
		requestFieldList.add(new RequestFieldResource("qtyPicked","Qty Picked","","Y"));
		requestFieldList.add(new RequestFieldResource("toContainer","To Container","","Y"));
		pickConfirmPickingAction.setRequestFieldList(requestFieldList);
		pickConfirmPickingAction.setResponseFieldList(null);


		RecordResource hdrResource = new RecordResource("Picks", "Picks", searchUrl, listUrl, getRecordUrl,
				addRecordUrl, updateRecordUrl, deleteRecordUrl, null, null, null, null, null, null,Arrays.asList(pickConfirmPickingAction));
	...
	private ScreenResource createPackingScreen(String busName, Integer locnNbr) {
		...
		requestFieldList.add(new RequestFieldResource("toContainer","To Container","","Y"));
		packConfirmPickingAction.setRequestFieldList(requestFieldList);
		packConfirmPickingAction.setResponseFieldList(null);
		RecordResource hdrResource = new RecordResource("Packs", "Packs", searchUrl, listUrl, getRecordUrl,
				addRecordUrl, updateRecordUrl, deleteRecordUrl, null, null, null, null, null, null,Arrays.asList(packConfirmPickingAction));
	...
	private ScreenResource createOrderPlannerScreen(String busName, Integer locnNbr) {
		ScreenResource customerOrdersScreen = new ScreenResource("OrderMaintenance",
				"Order Maintenance", "Orders", "R", UserConstants.MAINTENANCE_SCREEN, null, null);
		String searchUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr + "/order/search";
		String custOrdersListUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr + "/order";
		String custOrdersRecordUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr
				+ "/order/{id}";
		String custOrdersAddRecordUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr
				+ "/order";
		String custOrdersUpdateRecordUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr
				+ "/order" + "/{id}";
		String custOrdersDeleteRecordUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr
				+ "/order" + "/{id}";
		...
		startFullfillmentAction.setRequestFieldList(requestFieldList);
		startFullfillmentAction.setResponseFieldList(null);

		RecordResource customerOrderHdrResource = new RecordResource("Orders", "Orders", searchUrl,
				custOrdersListUrl, custOrdersRecordUrl, custOrdersAddRecordUrl, custOrdersUpdateRecordUrl,
				custOrdersDeleteRecordUrl, null, null, null, null, null, null, Arrays.asList(startFullfillmentAction));
		...
		customerOrdersScreen.setHdrResource(customerOrderHdrResource);
		List<RecordResource> dtlResources = new ArrayList();
		dtlResources.add(getOrderPlannerDtlResource(busName, locnNbr));
		customerOrdersScreen.setDtlResources(dtlResources);
		return customerOrdersScreen;

	}

	public RecordResource getOrderPlannerDtlResource(String busName, Integer locnNbr) {
		String searchUrl = "";
		...
		String custOrderDtldeleteRecordUrl = "https://the3dsoft.com/orderplanner/v1/" + busName + "/" + locnNbr
				+ "/order/{id}/dtl/{dtlId}";
		RecordResource orderDtlResource = new RecordResource("OrderPlannerDtl", "Order Details", searchUrl,
				custOrderDtlListUrl, custOrderDtlRecordUrl, custOrderDtlAddRecordUrl, custOrderDtlupdateRecordUrl,
				custOrderDtldeleteRecordUrl, null, null, null, null, null, null,null);
